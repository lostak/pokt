...
type Token struct {
	...
	GeckoId string           `protobuf:"bytes,2,opt,name=geckoId,proto3" json:"geckoId,omitempty"`
	Amounts []*AmountHistory `protobuf:"bytes,3,rep,name=amounts,proto3" json:"amounts,omitempty"`
}
...
var file_proto_portfolio_portfolio_proto_rawDesc = []byte{
	...
	0x12, 0x2e, 0x0a, 0x07, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
